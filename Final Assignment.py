...
-PY0220EN-SkillsNetwork/labs/project/revenue.htm'
...
def make_graph(stock_data, revenue_data, stock_name):
    fig = make_subplots(rows=2, cols=1, shared_xaxes=True, subplot_titles=("Historical Stock Price", "Historical Revenue"))

    fig.add_trace(go.Scatter(x=stock_data.Date, y=stock_data.Close, name="Stock Price"), row=1, col=1)
    fig.add_trace(go.Scatter(x=revenue_data.Date, y=revenue_data.Revenue, name="Revenue", line=dict(color='firebrick', width=4)), row=2, col=1)
    ...
    fig.update_layout(title_text=f"{stock_name} Stock Price and Revenue", height=800)
    fig.show()
